...
def predict_with_gpt(img: Path) -> Tuple[float, str]:
...
def main(dataset: Path,
    ...
    if resume_dir:
        ...
        out_dir = base / f"output_openai_{model_name}_date_{ts}"
    ...
    with log_path.open("a", encoding="utf-8") as logf, \
        ...
        for idx, img in enumerate(pending, 1):
            ...
            try:
                ...
                pred_val, full_resp = predict_with_gpt(img)
